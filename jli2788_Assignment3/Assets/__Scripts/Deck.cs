...
public class Deck : MonoBehaviour {
    ...
    public void Shuffle(ref List<Card> originalCards)
    {
        ...
        {
            index = Random.Range(0, originalCards.Count);
            temporaryCards.Add(originalCards[index]);
            originalCards.RemoveAt(index);
        }

        originalCards = temporaryCards;
    }
